 ...
 */
@Configuration
@MapperScan(basePackages = "com.fly.sharding.dao", sqlSessionTemplateRef = "test1SqlSessionTemplate")
public class DataSourceConfig {
	 ...
	 * user_id%2 取余为0则为test1数据源 1则为test2数据源
 	 * order_id%2 取余为
